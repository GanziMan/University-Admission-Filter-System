...
<head>
<meta charset="UTF-8">
<title>재외국민 12년 특별전형</title>
</head>
<body>
<h1>재외국민 12년 특별전형</h1>
<form:form method="POST" action="/Kim/expat12_input.do" commandName="msg">
<table>
	...
	<tr><td>학생의 점수</td><td><form:input path="student_score"/></td></tr>
	<tr><td>등록</td><td><input type="submit" value="전송"/></td></tr>	
</table>
</form:form>
<a href="/Kim/expat12_list.do"><button>재외국민12년 특별전형 List</button></a>
